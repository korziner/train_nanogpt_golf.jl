...
8-bit NorMuon + PCIe master weigts offload saves GPU mem (128 MB+) 
in Qwen37-Max.nanogpt_golf_v5_5.jl & deepseek.Qwen37-Max.nanogpt_golf_v5_5.jl
Позволяет претрейн более крупных языковых моделей, чем 15 миллионов параметров.

15-милионная сейчас --qat preteained:
```
мая 23 15:11:03 CF-C1 bash[2051]: step 30500/45000 │ loss 1.1503 │ ema 1.1612 │ bpb 1.659 │ lr 1.35e-04 │ rb 1.00 │ gnorm 0.19→0.19 │   1949 tok/s │ VRAM 0.03 GB free │ qat α=1.00 bits=8
мая 23 15:11:03 CF-C1 bash[2051]: ══════════ samples @ step 30500 ══════════
мая 23 15:11:11 CF-C1 bash[2051]: [1] Въ началѣ извѣстныхъ истина, подвинуты преимущественно называются въ истинѣ народной полосы науки, выраженныя подъ нами престолъ. Вотъ онъ проситъ его положительно отъ коническаго положенія въ столовой стѣнѣ. О
мая 23 15:11:19 CF-C1 bash[2051]: [2] На другой день принадлежалъ къ послѣднихъ новой императоровъ. По возможности послѣдней описать ее она не отказывались. Въ черномъ послѣднемъ отношенія съ другими, какъ съ другой стороны, было уже увѣрено продолжител
мая 23 15:11:27 CF-C1 bash[2051]: [3] Старикъ сказалъ : «Старица ты и меня веселишь въ отверстіе на свѣтѣ въ страданія ; онъ себѣ на свои маленькіе мучительные образы въ своихъ откахъ, которыя до нѣсколько вредныхъ животныхъ, которыя вы пришли на войну
мая 23 15:11:35 CF-C1 bash[2051]: [4] Она отвѣчала, что я прошу пожалъ ее за тобой надъ своимъ братья съ нами. Вотъ предложеніе о мое страданіе, какъ бы я въ сердцѣ со мною предложеніе въ собраніе моей имѣетъ право на богатѣйшимъ положеніемъ потерь, что въ
мая 23 15:11:42 CF-C1 bash[2051]: [5] Въ Петербургѣ величествую и она отправленію престанье своихъ отъ одной общей жизни. Мы видимъ, что возведенія отъ него не сдѣлаетъ своей дѣятельности въ солнечной истинѣ представляется потомъ труднымъ и тупостой по
мая 23 15:11:50 CF-C1 bash[2051]: [6] Господинъ отъ этого было невѣрнымъ благополучно, и всегда бы его больше со всего таковой собственной собственности. Еслибъ онъ не былъ бы совершенно предпринимателенъ, еслибъ и былъ не совершенъ въ подробности
мая 23 15:11:58 CF-C1 bash[2051]: [7] Исторія эта первая половина начала отъ такихъ половъ. Собравшись на одномъ изъ нихъ не высказывали дѣйствія и трава получили достаточно разнообразія во многомъ случая. Они должны исполнить свои странствованія и п
мая 23 15:11:58 CF-C1 bash[2051]: 📊 Space token (33): 218 / 1495 = 14.58%
мая 23 15:11:58 CF-C1 bash[2051]: 📊 Health: top=33 14.58% │ cyr2=83.75% │ unique=0.0328 │ H=4.59 bits │ max_run=2
мая 23 15:11:58 CF-C1 bash[2051]: 📊 Char diversity: bigram=0.225 trigram=0.225  (sampler: topk=40 topp=0.9 T=0.7)
мая 23 15:11:58 CF-C1 bash[2051]: ═══════════════════════════════════════════
мая 23 15:12:00 CF-C1 bash[2051]:   💾 ckpt saved: /home/koziner/14ext4/ckpt_11l384_cmp50/latest.jld2 │ good=yes │ best=0.9684
мая 23 15:14:47 CF-C1 bash[2051]: step 30510/45000 │ loss 1.1560 │ ema 1.1606 │ bpb 1.668 │ lr 1.35e-04 │ rb 1.00 │ gnorm 0.19→0.19 │   1462 tok/s │ VRAM 0.03 GB free │ qat α=1.00 bits=8
мая 23 15:17:36 CF-C1 bash[2051]: step 30520/45000 │ loss 1.1510 │ ema 1.1588 │ bpb 1.661 │ lr 1.35e-04 │ rb 1.00 │ gnorm 0.16→0.16 │   1943 tok/s │ VRAM 0.03 GB free │ qat α=1.00 bits=8
мая 23 15:20:26 CF-C1 bash[2051]: step 30530/45000 │ loss 1.1401 │ ema 1.1552 │ bpb 1.645 │ lr 1.35e-04 │ rb 1.00 │ gnorm 0.21→0.21 │   1930 tok/s │ VRAM 0.03 GB free │ qat α=1.00 bits=8
мая 23 15:23:18 CF-C1 bash[2051]: step 30540/45000 │ loss 1.1211 │ ema 1.1487 │ bpb 1.617 │ lr 1.35e-04 │ rb 1.00 │ gnorm 0.21→0.21 │   1908 tok/s │ VRAM 0.03 GB free │ qat α=1.00 bits=8
мая 23 15:26:07 CF-C1 bash[2051]: step 30550/45000 │ loss 1.1948 │ ema 1.1570 │ bpb 1.724 │ lr 1.35e-04 │ rb 1.00 │ gnorm 0.20→0.20 │   1935 tok/s │ VRAM 0.03 GB free │ qat α=1.00 bits=8
мая 23 15:26:09 CF-C1 bash[2051]:   💾 ckpt saved: /home/koziner/14ext4/ckpt_11l384_cmp50/latest.jld2 │ good=yes │ best=0.9684
```
TODO: bf16 Master weigts
...
```
julia -t3 count-tokens_v5_5.jl -d *.jsonl 📂 Файловъ для обработки: 1

[1/1] max-edit-dist4.max-ngram8.jsonl
   ✓ Обработано: 93292 строкъ | 85959565 токеновъ | 156.89 MB | 0.9 сек

══════════════════════════════════════════════════════════════════════
ОТЧЁТЪ О ПОДСЧЁТѢ ТОКЕНОВЪ
══════════════════════════════════════════════════════════════════════
Всего строкъ (сэмпловъ) обработано:  93292
Всего токеновъ (съ EOS):              85959565
Всего сырыхъ байтъ:                   156886030 (156.89 MB)
Средній коэффиціентъ сжатія:          1.825 байтъ/токенъ
Экономія противъ сырыхъ байтъ:        45.2%

Оцѣнка для обученія модели:
  • Токены безъ EOS:  85866273
  • При batch=4, seq=512, accum=16:
    ◦ Шаговъ на эпоху:  2621
    ◦ При 50k ток/сек: ~0.5 часовъ на эпоху
```
...
...
0    | 39   | 424    |     0.65 |     3.92 |   2.138 | +14.6%  
0    | 40   | 425    |     0.65 |     3.91 |   2.145 | +14.9%  
0    | 41   | 426    |     0.65 |     3.90 |   2.147 | +15.0% ★
0    | 42   | 427    |     0.66 |     3.90 |   2.147 | +15.0%
...
